# 🚀 Render Deployment Guide - Reviewly
...
- **Backend API:** `https://reviewly-backend.onrender.com`
- **Frontend App:** `https://reviewly-frontend.onrender.com`
...
**🎉 Congratulations! Your Reviewly app is now live on Render!**
