# 🚀 Reviewly - Deployment Guide

This guide covers multiple deployment options for the Reviewly full-stack application.
...
3. **Deploy Application:**
   ...
   # Start with PM2
   cd ../backend
    pm2 start app.js --name "reviewly-backend"
   pm2 startup
   pm2 save
   ```
...
4. **Configure Nginx:**
   ...
   # Create nginx config
    sudo nano /etc/nginx/sites-available/reviewly
   ```
